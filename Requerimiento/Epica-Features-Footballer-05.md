# Footballer - Epica y requerimientos a nivel feature v05

## 1. Control de version

- Version: 05.
- Documento base: `Requerimiento/Epica-Features-Footballer-04.md`.
- Respuesta incorporada: `Respuestas-Epica-Features-Footballer-04.md`.
...
- La capacidad de sede queda fuera del MVP.
...
- En el MVP no se capturan eventos parciales para partidos suspendidos.
...
- La tabla de goleadores permite posiciones compartidas.
...
- Los partidos suspendidos o reprogramados permiten modificar fecha y sede.
...
- Las exportaciones a Excel son tabulares.
